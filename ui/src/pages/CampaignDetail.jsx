        ...
        <div className="lg:col-span-2">
          ...
          {isClosed && !isCompleted && (
            <div className="mt-4 p-4 bg-orange-50 border border-orange-200 rounded-xl text-sm text-orange-700">
              This campaign has been closed by the admin and is no longer accepting donations.
            </div>
          )}
        ...
        <aside className="bg-white rounded-2xl border border-gray-100 p-5 shadow-sm h-fit sticky top-24">
          ...
          {isCompleted ? (
            <div className="mt-5 space-y-2">
              ...
              <Link to="/explore" className="block w-full text-center py-2.5 rounded-lg border border-gray-200 text-sm text-gray-600 hover:bg-gray-50 transition">
