...
const Home = () => {
  ...
  useEffect(() => {
    ...
    const url =
      category === "All"
        ? `${import.meta.env.VITE_API_URL}/campaign/featured`
        : `${import.meta.env.VITE_API_URL}/campaign/category/${category}`;
      ...
      <main className="max-w-5xl mx-auto px-6">
        <section className="mt-14 text-center">
          ...
          <p className="text-gray-600 mt-4 max-w-xl mx-auto">
            Discover trusted donation campaigns. Give directly to verified
            beneficiaries and track real impact.
          </p>
            ...
            <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {campaigns.map((c) => {
                ...
                return (
                  <article
                    key={c._id}
                    className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden hover:scale-105 transition"
                  >
